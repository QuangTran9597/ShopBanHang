...
<script type="text/javascript">
          $(document).ready(function(){
            ...
            //     $.ajax({
            //         url: 'http://localhost/shoplaravel/select-ship',
            //         method: 'POST',
            //         data:{ _token:_token},
            ...
            //     //  alert(ship);
            //     $.ajax({
            //         url: 'http://localhost/shoplaravel/insert-delivery',
            //         method: 'POST',
            //         data:{city:city, province:province, wards:wards, ship:ship , _token:_token},
            //         success:function(data){
            ...
            $('.choose').on('change',function(){
                ...
                $.ajax({
                    url: 'http://localhost/shoplaravel/select-delivery',
                    method: 'POST',
