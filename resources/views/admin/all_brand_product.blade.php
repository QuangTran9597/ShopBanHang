        ...
        <tbody>
          ...
          <tr>
            ...
            <td><span class="text-ellipsis">
                ...
                @if($cate_pro->brand_status == 0 )
                 ...
                 @else
                    ...
                    <a href="{{('active-brand-product/'.$cate_pro->brand_id)}}"><span
            ...
            <td>
              ...
              <a onclick="return confirm('Are you sure to delete?')" href="{{URL::to('delete-brand-product/'.$cate_pro->brand_id)}}" class="active styling-delete" ui-toggle-class="">
